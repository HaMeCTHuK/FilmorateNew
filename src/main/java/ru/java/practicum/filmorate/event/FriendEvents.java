...
public class FriendEvents implements Events {
    ...
    public void update(Long userId, Long entityId) {
        log.info("Событие обновление друга {} пользователем {} добавлено в БД", userId, entityId);
        eventsStorage.addEvent(userId, entityId, EventType.FRIEND, EventOperation.UPDATE);
    }
